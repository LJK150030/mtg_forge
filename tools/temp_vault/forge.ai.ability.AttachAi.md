...
classDiagram
    class AttachAi {
        ...
        -doAdvancedFlashAuraLogic(Player ai, SpellAbility sa, Card attachTarget) boolean
        -acceptableChoice(Card c, boolean mandatory) Card
        -chooseUnpreferred(boolean mandatory, List~Card~ list) Card
        -chooseLessPreferred(boolean mandatory, List~Card~ list) Card
        -attachAIChangeTypePreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAIKeepTappedPreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        +attachToPlayerAIPreferences(Player aiPlayer, SpellAbility sa, boolean mandatory, List~Player~ targetable) Player
        -attachAIAnimatePreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAIReanimatePreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAICuriosityPreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAISpecificCardPreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAIInstantReequipPreference(SpellAbility sa, Card attachSource) Card
        -attachAIControlPreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachAIHighestEvaluationPreference(List~Card~ list) Card
        -attachAICursePreference(SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource, Player ai) Card
        #doTriggerNoCost(Player ai, SpellAbility sa, boolean mandatory) AiAbilityDecision
        +chkDrawback(Player ai, SpellAbility sa) AiAbilityDecision
        -isAuraSpell(SpellAbility sa) boolean
        -attachPreference(SpellAbility sa, TargetRestrictions tgt, boolean mandatory) AiAbilityDecision
        -attachAIPumpPreference(Player ai, SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource) Card
        -attachToCardAIPreferences(Player aiPlayer, SpellAbility sa, boolean mandatory) Card
        +attachGeneralAI(Player ai, SpellAbility sa, List~Card~ list, boolean mandatory, Card attachSource, String logic) Card
        -containsUsefulCurseKeyword(List~String~ keywords, Card card, SpellAbility sa) boolean
        -isUsefulAttachKeyword(String keyword, Card card, SpellAbility sa, int powerBonus) boolean
        -isUsefulCurseKeyword(String keyword, Card card, SpellAbility sa) boolean
        -isUsefulAttachAction(Player ai, Card c, SpellAbility sa) boolean
        +doPumpOrCurseAILogic(Player ai, SpellAbility sa, List~Card~ list, String type) Card
    ...
    AttachAi --|> SpellAbilityAi : extends
    AttachAi ..> AiAbilityDecision : uses
    AttachAi ..> AiController : uses
    AttachAi ..> Card : uses
    AttachAi ..> CardCollection : uses
    AttachAi ..> CardCollectionView : uses
    AttachAi ..> Combat : uses
    AttachAi ..> Cost : uses
    AttachAi ..> CostPart : uses
    AttachAi ..> CostSacrifice : uses
    AttachAi ..> Game : uses
    AttachAi ..> GameObject : uses
    AttachAi ..> KeywordInterface : uses
    AttachAi ..> PhaseHandler : uses
    AttachAi ..> Player : uses
    AttachAi ..> PlayerActionConfirmMode : uses
    AttachAi ..> PlayerControllerAi : uses
    AttachAi ..> SpellAbility : uses
    AttachAi ..> StaticAbility : uses
    AttachAi ..> TargetRestrictions : uses
    AttachAi ..> Trigger : uses
```
