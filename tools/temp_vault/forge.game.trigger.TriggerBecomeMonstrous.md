...
fqn: forge.game.trigger.TriggerBecomeMonstrous
...
```mermaid
classDiagram
    class TriggerBecomeMonstrous {
        +performTest(Map~AbilityKey,Object~ runParams) boolean
        +setTriggeringObjects(SpellAbility sa, Map~AbilityKey,Object~ runParams) void
        +getImportantStackObjects(SpellAbility sa) String
        +TriggerBecomeMonstrous(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerBecomeMonstrous --|> Trigger : extends
    TriggerBecomeMonstrous ..> AbilityKey : uses
    TriggerBecomeMonstrous ..> Card : uses
    TriggerBecomeMonstrous ..> SpellAbility : uses
```
