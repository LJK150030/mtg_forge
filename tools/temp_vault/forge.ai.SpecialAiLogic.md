...
classDiagram
    class SpecialAiLogic {
        +doPongifyLogic(Player ai, SpellAbility sa) boolean
        +doAristocratLogic(Player ai, SpellAbility sa) boolean
        +doAristocratWithCountersLogic(Player ai, SpellAbility sa) AiAbilityDecision
        +doBranchCounterspellLogic(Player ai, SpellAbility sa) boolean
        +preferHasteForRiot(SpellAbility sa, Player player) boolean
    }
    SpecialAiLogic ..> AiAbilityDecision : uses
    SpecialAiLogic ..> Card : uses
    SpecialAiLogic ..> CardCollection : uses
    SpecialAiLogic ..> Combat : uses
    SpecialAiLogic ..> Game : uses
    SpecialAiLogic ..> PhaseHandler : uses
    SpecialAiLogic ..> Player : uses
    SpecialAiLogic ..> SpellAbility : uses
```
