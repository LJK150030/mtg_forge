...
fqn: forge.game.trigger.TriggerBecomesTargetOnce
...
```mermaid
classDiagram
    class TriggerBecomesTargetOnce {
        +performTest(Map~AbilityKey,Object~ runParams) boolean
        +setTriggeringObjects(SpellAbility sa, Map~AbilityKey,Object~ runParams) void
        +getImportantStackObjects(SpellAbility sa) String
        +TriggerBecomesTargetOnce(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerBecomesTargetOnce --|> Trigger : extends
    TriggerBecomesTargetOnce ..> AbilityKey : uses
    TriggerBecomesTargetOnce ..> Card : uses
    TriggerBecomesTargetOnce ..> SpellAbility : uses
```
