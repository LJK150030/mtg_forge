...
classDiagram
    class Card {
        ...
        -Map~CardStateName,CardState~ states
        -CardState currentState
        -CardStateName currentStateName
        -GamePieceType gamePieceType
        -Zone castFrom
        -SpellAbility castSA
        -Table~Long,Long,List~ hiddenExtrinsicKeywords
        -CardCollection hauntedBy
        -CardCollection devouredCards
        -CardCollection exploitedCards
        -CardCollection delvedCards
        -CardCollection imprintedCards
        -CardCollection exiledCards
        -CardCollection encodedCards
        -CardCollection gainControlTargets
        -CardCollection chosenCards
        -CardCollection mergedCards
        -Map~Long,CardCollection~ mustBlockCards
        -List~Card~ blockedThisTurn
        -List~Card~ blockedByThisTurn
        -CardCollection untilLeavesBattlefield
        -Card encoding
        -Card cloneOrigin
        -Card haunting
        -Card effectSource
        ...
        -Card meldedWith
        -Card mergedTo
        -SpellAbility effectSourceAbility
        -SpellAbility tokenSpawningAbility
        -GameEntity entityAttachedTo
        -Table~Long,Long,ICardChangedType~ changedCardTypesByText
        -Table~Long,Long,ICardChangedType~ changedCardTypesCharacterDefining
        -Table~Long,Long,ICardChangedType~ changedCardTypes
        -Table~Long,Long,CardChangedName~ changedCardNames
        -Table~Long,Long,IKeywordsChange~ changedCardKeywordsByText
        #KeywordsChange changedCardKeywordsByWord
        -Table~Long,Long,KeywordsChange~ changedCardKeywords
        -Map~Triple,KeywordInterface~ storedKeywords
        -Table~Long,Long,CardTraitChanges~ changedCardTraitsByText
        -Table~Long,Long,ICardTraitChanges~ changedCardTraits
        -Table~StaticAbility,String,SpellAbility~ storedSpellAbility
        -Table~StaticAbility,String,Trigger~ storedTrigger
        -Table~StaticAbility,SpellAbility,SpellAbility~ storedAbilityForTrigger
        -Table~StaticAbility,String,ReplacementEffect~ storedReplacementEffect
        -Table~StaticAbility,String,StaticAbility~ storedStaticAbility
        -Table~StaticAbility,SpellAbility,SpellAbility~ storedSpellAbililityByText
        -Table~StaticAbility,String,SpellAbility~ storedSpellAbililityGainedByText
        -Table~StaticAbility,Trigger,Trigger~ storedTriggerByText
        -Table~StaticAbility,ReplacementEffect,ReplacementEffect~ storedReplacementEffectByText
        -Table~StaticAbility,StaticAbility,StaticAbility~ storedStaticAbilityByText
        -Map~Triple,KeywordInterface~ storedKeywordByText
        -Table~Long,Long,CardColor~ changedCardColorsByText
        -Table~Long,Long,CardColor~ changedCardColorsCharacterDefining
        -Table~Long,Long,CardColor~ changedCardColors
        #Table~Long,Long,CardManaCost~ changedCardManaCost
        -NavigableMap~Long,CardCloneStates~ clonedStates
        -Table~Long,Long,Map~ changedSVars
        -Map~StaticAbility,CardPlayOption~ mayPlay
        -Map~Long,PlayerCollection~ mayLook
        -PlayerCollection mayLookFaceDownExile
        -PlayerCollection mayLookTemp
        -Multimap~Long,Keyword~ cantHaveKeywords
        -Map~CounterType,StaticAbility~ counterTypeKeywordStatic
        -Map~Long,Integer~ canBlockAdditional
        -Set~Long~ canBlockAny
        -CardChangedWords changedTextColors
        -CardChangedWords changedTextTypes
        -Set~Object~ rememberedObjects
        -List~String~ draftActions
        -Map~Player,String~ flipResult
        -List~Integer~ storedRolls
        -boolean isCommander
        -boolean canMoveToCommandZone
        -boolean startsGameInPlay
        -boolean drawnThisTurn
        -boolean foughtThisTurn
        -boolean enlistedThisCombat
        -boolean startedTheTurnUntapped
        -boolean cameUnderControlSinceLastUpkeep
        -boolean tapped
        -int tappedThisTurn
        -boolean sickness
        -boolean collectible
        ...
        -boolean tributed
        -Card preparedEffect
        -StaticAbility suspectedStatic
        -SpellAbility manifestedSA
        -SpellAbility cloakedSA
        -boolean foretold
        -boolean foretoldCostByEffect
        -boolean plotted
        -Set~CardStateName~ unlockedRooms
        -Map~CardStateName,SpellAbility~ unlockAbilities
        -boolean specialized
        -int timesCrewedThisTurn
        -CardCollection crewedByThisTurn
        -boolean saddled
        -int timesSaddledThisTurn
        -CardCollection saddledByThisTurn
        -boolean visitedThisTurn
        -int classLevel
        -boolean discarded
        -boolean surveilled
        -boolean milled
        -boolean flipped
        -boolean facedown
        -boolean turnedFaceUpThisTurn
        -boolean backside
        -Player phasedOut
        -boolean directlyPhasedOut
        -boolean wontPhaseInNormal
        -boolean usedToPayCost
        -boolean isEmblem
        -boolean isBoon
        -int exertThisTurn
        -PlayerCollection exertedByPlayer
        -PlayerCollection detainedByPlayer
        -PlayerCollection targetedFromThisTurn
        -long worldTimestamp
        -long bestowTimestamp
        -long transformedTimestamp
        -long prototypeTimestamp
        -long mutatedTimestamp
        -int timesMutated
        -long gameTimestamp
        -long layerTimestamp
        -Table~Long,Long,Pair~ newPTText
        -Table~Long,Long,Pair~ newPTCharacterDefining
        -Table~Long,Long,Pair~ newPT
        -Table~Long,Long,Pair~ boostPT
        -CardDamageHistory damageHistory
        -Map~Card,Integer~ assignedDamageMap
        -Map~Integer,Integer~ damage
        -boolean hasBeenDealtDeathtouchDamage
        -boolean hasBeenDealtExcessDamageThisTurn
        -int excessDamageThisTurnAmount
        -int shieldCount
        -int regeneratedThisTurn
        -int turnInZone
        -Player turnInController
        -Map~String,Integer~ xManaCostPaidByColor
        -Player owner
        -Player controller
        -long controllerTimestamp
        -NavigableMap~Long,Player~ tempControllers
        -String originalText
        -String text
        -String chosenType
        -String chosenType2
        -List~String~ notedTypes
        -List~String~ chosenColors
        -ColorSet markedColor
        -List~String~ chosenName
        -Integer chosenNumber
        -Player chosenPlayer
        -Player promisedGift
        -Player protectingPlayer
        ...
        -String chosenSector
        -int sprocket
        -Map~Player,CardCollection~ chosenMap
        -Card exiledWith
        -Player exiledBy
        -SpellAbility exiledSA
        -Map~Long,Player~ goad
        -List~GameCommand~ leavePlayCommandList
        -List~GameCommand~ untapCommandList
        -List~GameCommand~ changeControllerCommandList
        -List~GameCommand~ unattachCommandList
        -List~GameCommand~ faceupCommandList
        -List~GameCommand~ facedownCommandList
        -List~GameCommand~ phaseOutCommandList
        -List~Object[]~ staticCommandList
        -Zone currentZone
        -Zone savedLastKnownZone
        -int lkiCMC
        -CombatLki combatLKI
        #boolean renderForUi
        -CardView view
        -String overlayText
        -int planeswalkerAbilityActivated
        -boolean planeswalkerActivationLimitUsed
        -ActivationTable numberTurnActivations
        -ActivationTable numberGameActivations
        -ActivationTable numberAbilityResolved
        -Map~SpellAbility,List~ chosenModesTurn
        -Map~SpellAbility,List~ chosenModesGame
        -Map~SpellAbility,List~ chosenModesYourCombat
        -Map~SpellAbility,List~ chosenModesYourLastCombat
        -Table~SpellAbility,StaticAbility,List~ chosenModesTurnStatic
        -Table~SpellAbility,StaticAbility,List~ chosenModesGameStatic
        -Table~SpellAbility,StaticAbility,List~ chosenModesYourCombatStatic
        -Table~SpellAbility,StaticAbility,List~ chosenModesYourLastCombatStatic
        -ReplacementEffect shieldCounterReplaceDamage
        -ReplacementEffect shieldCounterReplaceDestroy
        -ReplacementEffect stunCounterReplaceUntap
        -ReplacementEffect finalityCounterReplaceDying
        -int intensity
        -List~PerpetualInterface~ perpetual
        -Map~PaperCard,Card~ cp2card
        +getHiddenId() int
        +getPrototypeTimestamp() long
        +getTransformedTimestamp() long
        +setTransformedTimestamp(long ts) void
        +updateAbilityTextForView() void
        +updateNonAbilityTextForView() void
        +updateManaCostForView() void
        +updatePTforView() void
        +updateTypesForView() void
        +updateColorForView() void
        +updateAttackingForView() void
        +updateBlockingForView() void
        +updateStateForView() void
        +getCurrentState() CardState
        +getAlternateStateName() CardStateName
        +getAlternateState() CardState
        +getState(CardStateName state) CardState
        +hasState(CardStateName state) boolean
        +getOriginalState(CardStateName state) CardState
        +getFaceDownState() CardState
        +setOriginalStateAsFaceDown() void
        +changeToState(CardStateName state) boolean
        +setState(CardStateName state, boolean updateView) boolean
        +setState(CardStateName state, boolean updateView, boolean forceUpdate) boolean
        +getStates() Set~CardStateName~
        +getCurrentStateName() CardStateName
        +setStates(Map~CardStateName,CardState~ map) void
        +addAlternateState(CardStateName state, boolean updateView) void
        +clearStates(CardStateName state, boolean updateView) void
        +changeCardState(String mode, String customState, SpellAbility cause) boolean
        +manifest(Player p, SpellAbility sa, Map~AbilityKey,Object~ params) Card
        +cloak(Player p, SpellAbility sa, Map~AbilityKey,Object~ params) Card
        +turnFaceDown() boolean
        +turnFaceDown(boolean override) boolean
        +turnFaceDownNoUpdate() boolean
        +canBeTurnedFaceUp() boolean
        +forceTurnFaceUp() void
        +turnFaceUp(SpellAbility cause) boolean
        +turnFaceUp(boolean runTriggers, SpellAbility cause) boolean
        +wasTurnedFaceUpThisTurn() boolean
        +canTransform(SpellAbility cause) boolean
        +getName() String
        +getName(CardState state) String
        +getDisplayName() String
        +getDisplayName(CardState state) String
        +hasNameOverwrite() boolean
        +hasNonLegendaryCreatureNames() boolean
        +setName(String name0) void
        +addChangedName(String name0, boolean addNonLegendaryCreatureNames, long timestamp, long staticId) void
        +removeChangedName(long timestamp, long staticId) boolean
        +removeChangedName(long timestamp, long staticId, boolean updateView) boolean
        +clearChangedName() boolean
        +updateNameforView() void
        +setGamePieceType(GamePieceType gamePieceType) void
        +getGamePieceType() GamePieceType
        +isToken() boolean
        +isRealToken() boolean
        +isCopiedSpell() boolean
        +isImmutable() boolean
        +isInAlternateState() boolean
        ...
        +isFlipCard() boolean
        +isSplitCard() boolean
        +isAdventureCard() boolean
        +isOnAdventure() boolean
        +isBackSide() boolean
        +setBackSide(boolean value) void
        +isCloned() boolean
        +isFaceDown() boolean
        +isRealFaceDown() boolean
        +setFaceDown(boolean value) void
        +isTransformed() boolean
        +isFlipped() boolean
        +setFlipped(boolean value) void
        +getDevouredCards() CardCollectionView
        +addDevoured(Card c) void
        +getExploited() CardCollectionView
        +addExploited(Card c) void
        +getDelved() CardCollectionView
        +addDelved(Card c) void
        +clearDelved() void
        +getConvoked() CardCollectionView
        +getEmerged() CardCollectionView
        +getRemembered() Iterable~Object~
        +hasRemembered() boolean
        +getRememberedCount() int
        +getFirstRemembered() Object
        +isRemembered(T o) boolean
        +addRemembered(T o) void
        +addRemembered(Iterable~T~ objects) void
        +removeRemembered(T o) void
        +removeRemembered(Iterable~T~ list) void
        +clearRemembered() void
        +updateRemembered() void
        +getImprintedCards() CardCollectionView
        +hasImprintedCard() boolean
        +hasImprintedCard(Card c) boolean
        +addImprintedCard(Card c) void
        +addImprintedCards(Iterable~Card~ cards) void
        +removeImprintedCard(Card c) void
        +removeImprintedCards(Iterable~Card~ cards) void
        +clearImprintedCards() void
        +addToChosenMap(Player p, CardCollection chosen) void
        +getChosenMap() Map~Player,CardCollection~
        +getGainControlTargets() CardCollectionView
        +addGainControlTarget(Card c) void
        +removeGainControlTargets(Card c) void
        +hasGainControlTarget() boolean
        +hasGainControlTarget(Card c) boolean
        +getUntilLeavesBattlefield() CardCollectionView
        +addUntilLeavesBattlefield(Card c) void
        +addUntilLeavesBattlefield(Iterable~Card~ cards) void
        +removeUntilLeavesBattlefield(Card c) void
        +removeUntilLeavesBattlefield(Iterable~Card~ cards) void
        +clearUntilLeavesBattlefield() void
        +getExiledCards() CardCollectionView
        +hasExiledCard() boolean
        +hasExiledCard(Card c) boolean
        +addExiledCard(Card c) void
        +addExiledCards(Iterable~Card~ cards) void
        +removeExiledCard(Card c) void
        +removeExiledCards(Iterable~Card~ cards) void
        +clearExiledCards() void
        +getHauntedBy() CardCollectionView
        +isHaunted() boolean
        +isHauntedBy(Card c) boolean
        +addHauntedBy(Card c, boolean update) void
        +addHauntedBy(Card c) void
        +removeHauntedBy(Card c) void
        +getHaunting() Card
        +setHaunting(Card c) void
        +getPairedWith() Card
        +setPairedWith(Card c) void
        +isPaired() boolean
        +getMeldedWith() Card
        +setMeldedWith(Card meldedWith) void
        +getEncodedCards() CardCollectionView
        +hasEncodedCard() boolean
        +hasEncodedCard(Card c) boolean
        +addEncodedCard(Card c) void
        +addEncodedCards(Iterable~Card~ cards) void
        +removeEncodedCard(Card c) void
        +clearEncodedCards() void
        +getEncodingCard() Card
        +setEncodingCard(Card e) void
        +getMergedCards() CardCollectionView
        +setMergedCards(Iterable~Card~ mc) void
        +getTopMergedCard() Card
        +hasMergedCard() boolean
        +addMergedCard(Card c) void
        +addMergedCardToTop(Card c) void
        +removeMergedCard(Card c) void
        +clearMergedCards() void
        +getMergedToCard() Card
        +setMergedToCard(Card c) void
        +isMerged() boolean
        +isMutated() boolean
        +getMutatedTimestamp() long
        +setMutatedTimestamp(long t) void
        +getTimesMutated() int
        +setTimesMutated(int t) void
        +removeMutatedStates() void
        +rebuildMutatedStates(CardTraitBase sa) void
        +getAllComponentCards(boolean includeSelf) CardCollection
        +moveMergedToSubgame(SpellAbility cause) void
        +retainPaidList(SpellAbility cause, String list) void
        +getStoredRolls() List~Integer~
        +getStoredRollsForView() List~String~
        +addStoredRolls(List~Integer~ results) void
        +replaceStoredRoll(Map~Integer,Integer~ replaceMap) void
        +getFlipResult(Player flipper) String
        +addFlipResult(Player flipper, String result) void
        +clearFlipResult() void
        +getXManaCostPaid() int
        +getXManaCostPaidByColor() Map~String,Integer~
        +setXManaCostPaidByColor(Map~String,Integer~ xByColor) void
        +getXManaCostPaidCount(String colors) int
        +getBlockedThisTurn() List~Card~
        +addBlockedThisTurn(Card attacker) void
        +clearBlockedThisTurn() void
        +getBlockedByThisTurn() List~Card~
        +addBlockedByThisTurn(Card blocker) void
        +clearBlockedByThisTurn() void
        +getMustBlockCards() CardCollectionView
        +addMustBlockCard(long ts, Card c) void
        +addMustBlockCards(long ts, Iterable~Card~ attackersToBlock) void
        +removeMustBlockCards(long ts) void
        +clearMustBlockCards() void
        +getCloneOrigin() Card
        +setCloneOrigin(Card cloneOrigin0) void
        +hasFirstStrike() boolean
        +hasDoubleStrike() boolean
        +hasSecondStrike() boolean
        +hasSuspend() boolean
        +hasConverge() boolean
        ...
        +createCounterStatic(CounterType counterType) boolean
        +subtractCounter(CounterType counterName, int n, Player remover) int
        +subtractCounter(CounterType counterName, int n, Player remover, boolean isDamage) int
        +setCounters(Map~CounterType,Integer~ allCounters) void
        +clearCounters() void
        +sumAllCounters() int
        +putEtbCounters(Map~Optional,Map~ etbCounters) void
        +getSVar(String var) String
        +hasSVar(String var) boolean
        +setSVar(String var, String str) void
        +copyChangedSVarsFrom(Card other) void
        +getSVars() Map~String,String~
        +setSVars(Map~String,String~ newSVars) void
        +removeSVar(String var) void
        +addChangedSVars(Map~String,String~ map, long timestamp, long staticId) void
        +removeChangedSVars(long timestamp, long staticId) void
        +getTurnInZone() int
        +setTurnInZone(int turn) void
        +enteredThisTurn() boolean
        +getTurnInController() Player
        +setTurnInController(Player p) void
        +setManaCost(ManaCost s) void
        +getOriginalManaCost() ManaCost
        +getManaCost() ManaCost
        +calculatePerpetualAdjustedManaCost() void
        +addChangedManaCost(ManaCost cost, boolean additional, long timestamp, long staticId) void
        +removeChangedManaCost(long timestamp, long staticId) boolean
        +hasChosenPlayer() boolean
        +getChosenPlayer() Player
        +setChosenPlayer(Player p) void
        +setSecretChosenPlayer(Player p) void
        +revealChosenPlayer() void
        +hasPromisedGift() boolean
        +getPromisedGift() Player
        +setPromisedGift(Player p) void
        +getProtectingPlayer() Player
        +setProtectingPlayer(Player p) void
        +hasChosenNumber() boolean
        +getChosenNumber() Integer
        +setChosenNumber(int i) void
        +setChosenNumber(int i, boolean secret) void
        +clearChosenNumber() void
        +getExiledWith() Card
        +setExiledWith(Card e) void
        +cleanupExiledWith() void
        +getExiledBy() Player
        +setExiledBy(Player ep) void
        +getExiledSA() SpellAbility
        +setExiledSA(SpellAbility sa) void
        +getChosenType() String
        +setChosenType(String s) void
        +hasChosenType() boolean
        +setSecretChosenType(String s) void
        +revealChosenType() void
        +getChosenType2() String
        +setChosenType2(String s) void
        +hasChosenType2() boolean
        +hasAnyNotedType() boolean
        +addNotedType(String type) void
        +getNotedTypes() Iterable~String~
        +getNumNotedTypes() int
        +getChosenColor() String
        +getChosenColors() Iterable~String~
        +setChosenColors(List~String~ s) void
        +hasChosenColor() boolean
        +hasChosenColor(String s) boolean
        +hasPaperFoil() boolean
        +setPaperFoil(boolean v) void
        +getMarkedColors() ColorSet
        +setMarkedColors(ColorSet s) void
        +hasMarkedColor() boolean
        +getChosenCard() Card
        +getChosenCards() CardCollectionView
        +setChosenCards(Iterable~Card~ cards) void
        +hasChosenCard() boolean
        +hasChosenCard(Card c) boolean
        +getChosenDirection() Direction
        +setChosenDirection(Direction chosenDirection0) void
        +getChosenMode() String
        +setChosenMode(String mode) void
        +getCurrentRoom() String
        +setCurrentRoom(String room) void
        +isInLastRoom() boolean
        +getSector() String
        +assignSector(String s) void
        +hasSector() boolean
        +getChosenSector() String
        +setChosenSector(String s) void
        +getSprocket() int
        +setSprocket(int sprocket) void
        +handleChangedControllerSprocketReset() void
        +getNamedCard() String
        +getNamedCards() List~String~
        +setNamedCards(List~String~ s) void
        +addNamedCard(String s) void
        +hasNamedCard() boolean
        +hasChosenEvenOdd() boolean
        +getChosenEvenOdd() EvenOdd
        +setChosenEvenOdd(EvenOdd chosenEvenOdd0) void
        +getSpellText() String
        +setText(String t) void
        +getNonAbilityText() String
        -keywordsToText(Collection~KeywordInterface~ keywords) String
        -kickerDesc(String keyword, String remText) String
        +getAbilityText() String
        +getAbilityText(CardState state) String
        -abilityTextInstantSorcery(CardState state) StringBuilder
        -formatSpellAbility(SpellAbility sa) String
        +canProduceColorMana(Set~String~ colors) boolean
        +canProduceSameManaTypeWith(Card c) boolean
        +getMaxManaProduced() int
        +getFirstSpellAbility() SpellAbility
        +getSpellPermanent() SpellPermanent
        +addSpellAbility(SpellAbility a) void
        +addSpellAbility(SpellAbility a, boolean updateView) void
        ...
        +hasRemoveIntrinsic() boolean
        +hasNoAbilities() boolean
        +updateSpellAbilities(List~SpellAbility~ list, CardState state) void
        +getAllSpellAbilities() FCollectionView~SpellAbility~
        +getSpells() FCollectionView~SpellAbility~
        +getBasicSpells() FCollectionView~SpellAbility~
        +getBasicSpells(CardState state) FCollectionView~SpellAbility~
        +getShieldCount() int
        +incShieldCount() void
        +decShieldCount() void
        +resetShieldCount() void
        +addRegeneratedThisTurn() void
        +getRegeneratedThisTurn() int
        +setRegeneratedThisTurn(int n) void
        +canBeShielded() boolean
        +updateTokenView() void
        +isTokenCard() boolean
        +setTokenCard(boolean tokenC) void
        +setCollectible(boolean collectible) void
        +isCollectible() boolean
        +updateWasDestroyed(boolean value) void
        +getCopiedPermanent() Card
        +setCopiedPermanent(Card c) void
        +addUntapCommand(GameCommand c) void
        +addUnattachCommand(GameCommand c) void
        +addFaceupCommand(GameCommand c) void
        +addFacedownCommand(GameCommand c) void
        +addChangeControllerCommand(GameCommand c) void
        +addPhaseOutCommand(GameCommand c) void
        +addLeavesPlayCommand(GameCommand c) void
        +addStaticCommandList(Object[] objects) void
        +getStaticCommandList() List~Object[]~
        +getLeavesPlayCommands() List~GameCommand~
        +setLeavesPlayCommands(List~GameCommand~ list) void
        +runLeavesPlayCommands() void
        +runUntapCommands() void
        +runUnattachCommands() void
        +runFaceupCommands() void
        +runFacedownCommands() void
        +runChangeControllerCommands() void
        +runPhaseOutCommands() void
        +setSickness(boolean sickness0) void
        +hasSickness() boolean
        +isSick() boolean
        +isFirstTurnControlled() boolean
        +hasBecomeTargetThisTurn() boolean
        +addTargetFromThisTurn(Player p) void
        +isValiant(Player p) boolean
        +hasStartedTheTurnUntapped() boolean
        +setStartedTheTurnUntapped(boolean untapped) void
        +cameUnderControlSinceLastUpkeep() boolean
        +setCameUnderControlSinceLastUpkeep(boolean underControlSinceLastUpkeep) void
        +getOwner() Player
        +setOwner(Player owner0) void
        +getController() Player
        +setController(Player player, long tstamp) void
        +addTempController(Player player, long tstamp) void
        +removeTempController(long tstamp) void
        +removeTempController(Player player) void
        +clearTempControllers() void
        +clearControllers() void
        +mayPlayerLook(Player player) boolean
        +addMayLookFaceDownExile(Player p) void
        +addMayLookAt(long timestamp, Iterable~Player~ list) void
        +removeMayLookAt(long timestamp) void
        +addMayLookTemp(Player player) void
        +removeMayLookTemp(Player player) void
        +updateMayLook() void
        +updateMayPlay() void
        +mayPlay(StaticAbility sta) CardPlayOption
        +mayPlay(Player player) List~CardPlayOption~
        +setMayPlay(Player player, boolean withoutManaCost, Cost altManaCost, boolean withFlash, boolean grantZonePermissions, StaticAbility sta) void
        +removeMayPlay(StaticAbility sta) void
        +getMayPlay() Map~StaticAbility,CardPlayOption~
        +setMayPlay(Map~StaticAbility,CardPlayOption~ mp) Map~StaticAbility,CardPlayOption~
        +resetMayPlayTurn() void
        +getEquippedBy() CardCollectionView
        +isEquipped() boolean
        +isEquippedBy(Card c) boolean
        +isEquippedBy(String cardName) boolean
        +getFortifiedBy() CardCollectionView
        +isFortified() boolean
        +isFortifiedBy(Card c) boolean
        +isFortifying() boolean
        +getEquipping() Card
        +isEquipping() boolean
        +getEntityAttachedTo() GameEntity
        +setEntityAttachedTo(GameEntity e) void
        +removeAttachedTo(GameEntity e) void
        +isAttachedToEntity() boolean
        +isAttachedToEntity(GameEntity e) boolean
        +getAttachedTo() Card
        +getEnchantingCard() Card
        +getPlayerAttachedTo() Player
        +isEnchanting() boolean
        +isEnchantingCard() boolean
        +attachToEntity(GameEntity entity, SpellAbility sa) void
        +attachToEntity(GameEntity entity, SpellAbility sa, boolean overwrite) void
        +unattachFromEntity(GameEntity entity) void
        +unattachFromEntity(GameEntity entity, GameEntity old) void
        +isModified() boolean
        ...
        +getOriginalType() CardTypeView
        +getOriginalType(CardState state) CardTypeView
        +getChangedCardTypes() Iterable~ICardChangedType~
        +clearChangedCardTypes() boolean
        +clearChangedCardColors() boolean
        +getChangedCardKeywordsByText() Table~Long,Long,IKeywordsChange~
        +getChangedCardKeywordsList(CardState state) Iterable~IKeywordsChange~
        +getChangedCardKeywords() Table~Long,Long,KeywordsChange~
        +setChangedCardKeywords(Table~Long,Long,KeywordsChange~ changedCardKeywords) void
        +addChangedCardTypesByText(CardTypeView addType, long timestamp, long staticId) void
        +removeChangedCardTypesByText(long timestamp, long staticId) boolean
        +addChangedCardTypes(CardType addType, CardType removeType, boolean addAllCreatureTypes, Set~RemoveType~ remove, long timestamp, long staticId, boolean updateView, boolean cda) void
        +removeChangedCardTypes(long timestamp, long staticId) boolean
        +removeChangedCardTypes(long timestamp, long staticId, boolean updateView) boolean
        +updateTypeCache() void
        +hasChangedCardColors() boolean
        +addColorByText(ColorSet color, boolean addToColors, long timestamp, StaticAbility stAb) void
        +removeColorByText(long timestampIn, long staticId) void
        +addColor(ColorSet color, boolean addToColors, long timestamp, StaticAbility stAb) void
        +removeColor(long timestampIn, long staticId) void
        +setColor(String color) void
        +setColor(ColorSet color) void
        +getColor() ColorSet
        +getColor(CardState state) ColorSet
        +getCurrentLoyalty() int
        +setBaseLoyalty(int n) void
        +getCurrentDefense() int
        +setBaseDefense(int n) void
        +getAttractionLights() Set~Integer~
        +setAttractionLights(Set~Integer~ attractionLights) void
        +getBasePower() int
        +getBaseToughness() int
        +setBasePower(int n) void
        +setBaseToughness(int n) void
        ...
        +addCloneState(CardCloneStates states, long timestamp) void
        +removeCloneState(long timestamp) boolean
        +removeCloneState(CardTraitBase ctb) boolean
        +getCloner() Card
        +removeCloneStates() boolean
        +getCloneStates() Map~Long,CardCloneStates~
        +setCloneStates(Map~Long,CardCloneStates~ val) void
        -updateCloneState(boolean updateView) void
        +getFaceupCardStateName() CardStateName
        -getLastClonedState() CardCloneStates
        +getSetPTTable() Table~Long,Long,Pair~
        +setPTTable(Table~Long,Long,Pair~ table) void
        +getSetPTCharacterDefiningTable() Table~Long,Long,Pair~
        +setPTCharacterDefiningTable(Table~Long,Long,Pair~ table) void
        +addNewPTByText(Integer power, Integer toughness, long timestamp, long staticId) void
        +removeNewPTbyText(long timestamp, long staticId) boolean
        +addNewPT(Integer power, Integer toughness, long timestamp, long staticId) void
        +addNewPT(Integer power, Integer toughness, long timestamp, long staticId, boolean cda, boolean updateView) void
        +removeNewPT(long timestamp, long staticId) void
        +removeNewPT(long timestamp, long staticId, boolean updateView) boolean
        +getPTIterable() Iterable~Pair~
        +clearNewPT() boolean
        +getCurrentPower() int
        +getUnswitchedPowerBreakdown() StatBreakdown
        +getUnswitchedPower() int
        +getPowerBonusFromCounters() int
        +getNetPowerBreakdown() StatBreakdown
        +getNetPower() int
        +getCurrentToughness() int
        +getUnswitchedToughnessBreakdown() StatBreakdown
        +getUnswitchedToughness() int
        +getToughnessBonusFromCounters() int
        +getNetToughnessBreakdown() StatBreakdown
        +getNetToughness() int
        +toughnessAssignsDamage() boolean
        +assignNoCombatDamage() boolean
        +getNetCombatDamage() int
        +getTempPowerBoost() int
        +getTempToughnessBoost() int
        +addPTBoost(int power, int toughness, long timestamp, long staticId) void
        +removePTBoost(long timestamp, long staticId) boolean
        +getPTBoostTable() Table~Long,Long,Pair~
        +setPTBoost(Table~Long,Long,Pair~ table) void
        +getDraftActions() List~String~
        +addDraftAction(String s) void
        +addIntensity(int n) void
        +getIntensity(boolean total) int
        +setIntensity(int n) void
        +hasIntensity() boolean
        +hasPerpetual() boolean
        +getPerpetual() List~PerpetualInterface~
        +addPerpetual(PerpetualInterface p) void
        +removePerpetual(long timestamp) void
        +setPerpetual(Card oldCard) void
        +setPerpetual(Card oldCard, boolean applyEffects) void
        +isUntapped() boolean
        +isTapped() boolean
        +setTapped(boolean tapped0) void
        +canTap() boolean
        +canTap(boolean attacker) boolean
        +tap(boolean tapAnimation, SpellAbility cause, Player tapper) boolean
        +tap(boolean attacker, boolean tapAnimation, SpellAbility cause, Player tapper) boolean
        +canUntap(Player phase, boolean predict) boolean
        +untap() boolean
        +untap(Player phase) boolean
        +getSpellAbilityForStaticAbility(String str, StaticAbility stAb) SpellAbility
        +getTriggerForStaticAbility(String str, StaticAbility stAb) Trigger
        +addTriggerForStaticAbility(Trigger trig, StaticAbility stAb) Trigger
        +setStoredReplacements(Table~StaticAbility,String,ReplacementEffect~ table) void
        +getStoredReplacements() Table~StaticAbility,String,ReplacementEffect~
        +getReplacementEffectForStaticAbility(String str, StaticAbility stAb) ReplacementEffect
        +getStaticAbilityForStaticAbility(String str, StaticAbility stAb) StaticAbility
        +getSpellAbilityForStaticAbilityByText(SpellAbility sa, StaticAbility stAb) SpellAbility
        +getSpellAbilityForStaticAbilityGainedByText(String str, StaticAbility stAb) SpellAbility
        +getTriggerForStaticAbilityByText(Trigger tr, StaticAbility stAb) Trigger
        +getReplacementEffectForStaticAbilityByText(ReplacementEffect re, StaticAbility stAb) ReplacementEffect
        +getStaticAbilityForStaticAbilityByText(StaticAbility st, StaticAbility stAb) StaticAbility
        +getKeywordForStaticAbilityByText(KeywordInterface ki, StaticAbility stAb, long idx) KeywordInterface
        -canUseCachedTrait(CardTraitBase cached, CardTraitBase stAb) boolean
        +getChangedCardTraitsByText() Table~Long,Long,CardTraitChanges~
        +setChangedCardTraitsByText(Table~Long,Long,CardTraitChanges~ changes) void
        +addChangedCardTraitsByText(Collection~SpellAbility~ spells, Collection~Trigger~ trigger, Collection~ReplacementEffect~ replacements, Collection~StaticAbility~ statics, long timestamp, long staticId) void
        +addChangedCardTraits(Collection~SpellAbility~ spells, Collection~Trigger~ trigger, Collection~ReplacementEffect~ replacements, Collection~StaticAbility~ statics, Predicate~CardTraitBase~ remove, long timestamp, long staticId) ICardTraitChanges
        +addChangedCardTraits(Collection~SpellAbility~ spells, Collection~Trigger~ trigger, Collection~ReplacementEffect~ replacements, Collection~StaticAbility~ statics, Predicate~CardTraitBase~ remove, long timestamp, long staticId, boolean updateView) ICardTraitChanges
        +addChangedCardTraits(ICardTraitChanges changes, long timestamp, long staticId, boolean updateView) ICardTraitChanges
        +removeChangedCardTraits(long timestamp, long staticId) boolean
        +removeChangedCardTraitsByText(long timestamp, long staticId) boolean
        +getChangedCardTraitsList(CardState state) Iterable~ICardTraitChanges~
        +getChangedCardTraits() Table~Long,Long,ICardTraitChanges~
        +setChangedCardTraits(Table~Long,Long,ICardTraitChanges~ changes) void
        +clearChangedCardTraits() boolean
        +getKeywords() List~KeywordInterface~
        +getKeywords(CardState state) List~KeywordInterface~
        +visitKeywords(CardState state, Visitor~KeywordInterface~ visitor) void
        +hasKeyword(Keyword keyword) boolean
        +hasKeyword(Keyword key, CardState state) boolean
        +hasKeyword(String keyword) boolean
        +hasKeyword(String keyword, CardState state) boolean
        +updateKeywords() void
        +addChangedCardKeywords(List~String~ keywords, List~String~ removeKeywords, boolean removeAllKeywords, long timestamp, StaticAbility st) void
        +addChangedCardKeywords(List~String~ keywords, List~String~ removeKeywords, boolean removeAllKeywords, long timestamp, StaticAbility st, boolean updateView) void
        +getKeywordForStaticAbility(String kw, StaticAbility st, long idx) KeywordInterface
        +addKeywordForStaticAbility(KeywordInterface kw) void
        +getStoredKeywords() Map~Triple,KeywordInterface~
        +setStoredKeywords(Map~Triple,KeywordInterface~ map, boolean lki) void
        -getCopyForStoredKeyword(Map.Entry~Triple,KeywordInterface~ e, boolean lki) KeywordInterface
        +addChangedCardKeywordsByText(List~KeywordInterface~ keywords, long timestamp, long staticId, boolean updateView) void
        +setChangedCardKeywordsByText(Table~Long,Long,IKeywordsChange~ changedCardKeywords) void
        +addChangedCardKeywordsInternal(Collection~KeywordInterface~ keywords, Collection~KeywordInterface~ removeKeywords, boolean removeAllKeywords, long timestamp, StaticAbility st, boolean updateView) void
        +removeChangedCardKeywords(long timestamp, long staticId) boolean
        +removeChangedCardKeywords(long timestamp, long staticId, boolean updateView) boolean
        +removeChangedCardKeywordsByText(long timestamp, long staticId) boolean
        +clearChangedCardKeywords() boolean
        +clearChangedCardKeywords(boolean updateView) boolean
        +clearStaticChangedCardKeywords(boolean updateView) boolean
        +getUnhiddenKeywords() KeywordCollection
        +getUnhiddenKeywords(CardState state) KeywordCollection
        +updateKeywordsCache() void
        +updateKeywordsCache(CardState state) void
        -visitUnhiddenKeywords(CardState state, Visitor~KeywordInterface~ visitor) void
        +addIntrinsicKeyword(String s) KeywordInterface
        +addIntrinsicKeywords(Iterable~String~ s) void
        +addIntrinsicKeywords(Iterable~String~ s, boolean initTraits) void
        +removeIntrinsicKeyword(Keyword k) void
        +getHiddenExtrinsicKeywords() Iterable~String~
        +getHiddenExtrinsicKeywordsTable() Table~Long,Long,List~
        +addHiddenExtrinsicKeywords(long timestamp, long staticId, Iterable~String~ keywords) void
        +removeHiddenExtrinsicKeywords(long timestamp, long staticId) void
        +removeHiddenExtrinsicKeyword(String s) void
        +hasStartOfKeyword(String keyword) boolean
        +hasStartOfKeyword(String keyword, CardState state) boolean
        +hasStartOfUnHiddenKeyword(String keyword) boolean
        +hasStartOfUnHiddenKeyword(String keyword, CardState state) boolean
        +hasAnyKeyword(Iterable~String~ keywords) boolean
        +hasAnyKeyword(Iterable~String~ keywords, CardState state) boolean
        +getAmountOfKeyword(String k) int
        +getAmountOfKeyword(String k, CardState state) int
        +getAmountOfKeyword(Keyword k) int
        +getAmountOfKeyword(Keyword k, CardState state) int
        +getKeywords(Keyword k) Collection~KeywordInterface~
        +getKeywords(Keyword k, CardState state) Collection~KeywordInterface~
        +getKeywordMagnitude(Keyword k) int
        +getKeywordMagnitude(Keyword k, CardState state) int
        +addCantHaveKeyword(Keyword keyword, Long timestamp) void
        +addCantHaveKeyword(Long timestamp, Iterable~Keyword~ keywords) void
        +removeCantHaveKeyword(Long timestamp) boolean
        +removeCantHaveKeyword(Long timestamp, boolean updateView) boolean
        +getCantHaveKeyword() Collection~Keyword~
        +addChangedTextColorWord(String originalWord, String newWord, Long timestamp, long staticId) void
        +removeChangedTextColorWord(Long timestamp, long staticId) void
        +addChangedTextTypeWord(String originalWord, String newWord, Long timestamp, long staticId) void
        +removeChangedTextTypeWord(Long timestamp, long staticId) void
        +updateChangedText() void
        +getChangedTextColorWords() ImmutableMap~String,String~
        +getChangedTextTypeWords() ImmutableMap~String,String~
        +copyChangedTextFrom(Card other) void
        +isPermanent() boolean
        +isSpell() boolean
        +hasPlayableLandFace() boolean
        +isLand() boolean
        +isBasicLand() boolean
        +isSnow() boolean
        +isKindred() boolean
        ...
        +isOutlaw() boolean
        +isRoom() boolean
        +compareTo(Card that) int
        +toString() String
        +isUnearthed() boolean
        +setUnearthed(boolean b) void
        +isPhasedOut() boolean
        +isPhasedOut(Player turn) boolean
        +getPhasedOut() Player
        +setPhasedOut(Player phasedOut0) void
        +phase(boolean fromUntapStep) void
        +phase(boolean fromUntapStep, boolean direct) void
        -switchPhaseState(boolean fromUntapStep) boolean
        +isDirectlyPhasedOut() boolean
        +setDirectlyPhasedOut(boolean direct) void
        +isWontPhaseInNormal() boolean
        +setWontPhaseInNormal(boolean phaseFlag) void
        +isReflectedLand() boolean
        ...
        +isEmblem() boolean
        +setEmblem(boolean isEmblem0) void
        +isBoon() boolean
        +setBoon(boolean isBoon0) void
        +isOfColor(String col) boolean
        +isBlack() boolean
        +isBlue() boolean
        +isRed() boolean
        +isGreen() boolean
        +isWhite() boolean
        +isColorless() boolean
        +associatedWithColor(String col) boolean
        +hasNoName() boolean
        +sharesNameWith(Card c1) boolean
        +sharesNameWith(String name) boolean
        +sharesColorWith(Card c1) boolean
        +sharesCMCWith(int n) boolean
        +sharesCMCWith(Card c1) boolean
        +sharesCreatureTypeWith(Card c1) boolean
        +sharesLandTypeWith(Card c1) boolean
        +sharesPermanentTypeWith(Card c1) boolean
        +sharesCardTypeWith(Card c1) boolean
        +sharesAllCardTypesWith(Card c1) boolean
        +sharesControllerWith(Card c1) boolean
        +hasABasicLandType() boolean
        +hasANonBasicLandType() boolean
        +isUsedToPay() boolean
        +setUsedToPay(boolean b) void
        +getDamageHistory() CardDamageHistory
        +setDamageHistory(CardDamageHistory history) void
        +hasDealtDamageToOpponentThisTurn() boolean
        +getTotalDamageDoneBy() int
        +getLethal() int
        +getLethalDamage() int
        +getExcessDamageValue(boolean withDeathtouch) int
        +getDamage() int
        +setDamage(int damage0) void
        +getMaxDamageFromSource() int
        +hasBeenDealtDeathtouchDamage() boolean
        +setHasBeenDealtDeathtouchDamage(boolean hasBeenDealtDeatchtouchDamage) void
        +hasBeenDealtExcessDamageThisTurn() boolean
        +setHasBeenDealtExcessDamageThisTurn(boolean bool) void
        +logExcessDamage(int n) void
        +getExcessDamageThisTurn() int
        +setExcessDamageReceivedThisTurn(int n) void
        -resetExcessDamage() void
        +getAssignedDamageMap() Map~Card,Integer~
        +addAssignedDamage(int assignedDamage0, Card sourceCard) void
        +clearAssignedDamage() void
        +getTotalAssignedDamage() int
        +canDamagePrevented(boolean isCombat) boolean
        +staticReplaceDamage(int damage, Card source, boolean isCombat) int
        +addDamageAfterPrevention(int damageIn, Card source, SpellAbility cause, boolean isCombat, GameEntityCounterTable counterTable) int
        +setRandomFoil() void
        +setFoil(int f) void
        +borderColor() CardEdition.BorderColor
        +getMostRecentSet() String
        +getSetCode() String
        +setSetCode(String setCode) void
        +getRarity() CardRarity
        +setRarity(CardRarity r) void
        +getImageKey() String
        +setImageKey(String iFN) void
        +getImageKey(CardStateName state) String
        +getFacedownImageKey() String
        +isTributed() boolean
        +setTributed(boolean b) void
        +getTokenSpawningAbility() SpellAbility
        +setTokenSpawningAbility(SpellAbility sa) void
        +isEmbalmed() boolean
        +isEternalized() boolean
        +getExertedThisTurn() int
        +exert() void
        +exert(Player p) void
        +isExertedBy(Player player) boolean
        +removeExertedBy(Player player) void
        #resetExertedThisTurn() void
        +isDetained() boolean
        +detain(Player player) void
        +removeDetainedBy(Player player) void
        +isMadness() boolean
        +getDrawnThisTurn() boolean
        +setDrawnThisTurn(boolean b) void
        +getFoughtThisTurn() boolean
        +setFoughtThisTurn(boolean b) void
        +getEnlistedThisCombat() boolean
        +setEnlistedThisCombat(boolean b) void
        +wasDiscarded() boolean
        +setDiscarded(boolean state) void
        +wasSurveilled() boolean
        +setSurveilled(boolean value) void
        +wasMilled() boolean
        +setMilled(boolean value) void
        +isRingBearer() boolean
        +setRingBearer(boolean ringbearer0) void
        +clearRingBearer() void
        +isHarnessed() boolean
        +setHarnessed(boolean harnessed0) boolean
        +isMonstrous() boolean
        +setMonstrous(boolean monstrous0) void
        +isRenowned() boolean
        +setRenowned(boolean renowned0) void
        +isSolved() boolean
        +setSolved(boolean solved) boolean
        +getTimesSaddledThisTurn() int
        +getSaddledByThisTurn() CardCollection
        +addSaddledByThisTurn(CardCollection saddlers) void
        +setSaddledByThisTurn(CardCollection saddlers) void
        +resetSaddled() void
        +isSaddled() boolean
        +setSaddled(boolean saddled) boolean
        +getSuspectedStatic() StaticAbility
        +setSuspectedStatic(StaticAbility stAb) void
        +isSuspected() boolean
        +setSuspected(boolean suspected) boolean
        +isPrepared() boolean
        +getPrepared() Card
        +setPrepared(Card eff) void
        +isManifested() boolean
        +getManifestedSA() SpellAbility
        +setManifested(SpellAbility sa) void
        +isCloaked() boolean
        +getCloakedSA() SpellAbility
        +setCloaked(SpellAbility sa) void
        +isForetold() boolean
        +setForetold(boolean foretold) void
        +isPlotted() boolean
        +setPlotted(boolean plotted) boolean
        +isForetoldCostByEffect() boolean
        +setForetoldCostByEffect(boolean val) void
        +isWarped() boolean
        +isWebSlinged() boolean
        +isSpecialized() boolean
        +setSpecialized(boolean bool) void
        +canSpecialize() boolean
        +canCrew() boolean
        +getTimesCrewedThisTurn() int
        +setTimesCrewedThisTurn(int t) void
        +resetTimesCrewedThisTurn() void
        +becomesCrewed(SpellAbility sa) void
        +resetCrewed() void
        +addCrewedByThisTurn(CardCollection crew) void
        +getCrewedByThisTurn() CardCollectionView
        +setCrewedByThisTurn(CardCollectionView crew) void
        +visitAttraction(Player visitor) void
        +wasVisitedThisTurn() boolean
        +getClassLevel() int
        +setClassLevel(int level) void
        +isClassCard() boolean
        +setOverlayText(String overlayText) void
        +getOverlayText() String
        +animateBestow() void
        +animateBestow(boolean updateView) void
        +unanimateBestow() void
        +unanimateBestow(boolean updateView) void
        +isBestowed() boolean
        +getBestowTimestamp() long
        +setBestowTimestamp(long t) void
        +getGameTimestamp() long
        +setGameTimestamp(long t) void
        +getLayerTimestamp() long
        +setLayerTimestamp(long t) void
        +equalsWithGameTimestamp(Card c) boolean
        +getWorldTimestamp() long
        +updateWorldTimestamp(long ts) void
        +getZone() Zone
        +setZone(Zone zone) void
        +isInZone(ZoneType zone) boolean
        +isInZones(List~ZoneType~ zones) boolean
        +canBeDiscardedBy(SpellAbility sa, boolean effect) boolean
        +canBeDestroyed() boolean
        +canBeTargetedBy(SpellAbility sa) boolean
        +canBeControlledBy(Player newController) boolean
        #cantBeEnchantedByMsg(Card aura) String
        #cantBeEquippedByMsg(Card equip, SpellAbility sa) String
        #cantBeFortifiedByMsg(Card fort) String
        +cantBeAttachedMsg(Card attach, SpellAbility sa, boolean checkSBA) String
        +canBeSacrificedBy(SpellAbility source, boolean effect) boolean
        +canExiledBy(SpellAbility source, boolean effect) boolean
        +getStaticAbilities() FCollectionView~StaticAbility~
        +addStaticAbility(String s) StaticAbility
        +addStaticAbility(StaticAbility stAb) StaticAbility
        +updateStaticAbilities(List~StaticAbility~ list, CardState state) void
        +getHiddenStaticAbilities() FCollectionView~StaticAbility~
        +getTriggers() FCollectionView~Trigger~
        +addTrigger(Trigger t) Trigger
        +hasTrigger(Trigger t) boolean
        +hasTrigger(int id) boolean
        +updateTriggers(List~Trigger~ list, CardState state) void
        +getReplacementEffects() FCollectionView~ReplacementEffect~
        +addReplacementEffect(ReplacementEffect replacementEffect) ReplacementEffect
        +updateReplacementEffects(List~ReplacementEffect~ list, CardState state, boolean rulesHost) void
        ...
        +getCastFrom() Zone
        +setCastFrom(Zone castFrom0) void
        +wasCast() boolean
        +getCastSA() SpellAbility
        +setCastSA(SpellAbility castSA) void
        +getEffectSource() Card
        +getEffectSourceAbility() SpellAbility
        +setEffectSource(Card src) void
        +setEffectSource(SpellAbility sa) void
        +isStartsGameInPlay() boolean
        +setStartsGameInPlay(boolean startsGameInPlay0) void
        +isInPlay() boolean
        +onEndOfCombat(Player active) void
        +onCleanupPhase(Player turn) void
        +hasETBTrigger(boolean drawbackOnly) boolean
        +hasETBReplacement() boolean
        +getCMC() int
        +getCMC(SplitCMCMode mode) int
        +setLKICMC(int cmc) void
        +isLKI() boolean
        +getRules() CardRules
        +updateRulesView() void
        +getGame() Game
        +dangerouslySetGame(Game newGame) void
        +isCommander() boolean
        +isRealCommander() boolean
        +setCommander(boolean b) void
        +updateCommanderView() void
        +getRealCommander() Card
        +canMoveToCommandZone() boolean
        +setMoveToCommandZone(boolean b) void
        +setSplitStateToPlayAbility(SpellAbility sa) void
        +isOptionalCostPaid(OptionalCost cost) boolean
        +getKickerMagnitude() int
        +getAllPossibleAbilities(Player player, boolean removeUnplayable) List~SpellAbility~
        +getAllPossibleAbilities(Player player, boolean removeUnplayable, Multimap~SpellAbility,SpellAbility~ unhiddenAltCost) List~SpellAbility~
        +fromPaperCard(IPaperCard pc, Player owner) Card
        +getCardForUi(IPaperCard pc) Card
        +getCardForUi(Card c) Card
        +getCardForUi() Card
        +getRenderForUI() boolean
        +setRenderForUI(boolean value) void
        +getPaperCard() IPaperCard
        +updateCard(PaperCard pc) void
        ...
        +getView() CardView
        +cleanupCopiedChangesFrom(Card c) void
        +addGoad(Long timestamp, Player p) void
        +removeGoad(Long timestamp) void
        +isGoaded() boolean
        +unGoad() void
        +isGoadedBy(Player p) boolean
        +getGoaded() PlayerCollection
        +getGoadMap() Map~Long,Player~
        +getLastKnownZone() Zone
        +setLastKnownZone(Zone zone) void
        +hasChapter() boolean
        +getFinalChapterNr() int
        +activatedThisTurn() boolean
        +addAbilityActivated(SpellAbility ability) void
        +getAbilityActivatedThisTurn() ActivationTable
        +getAbilityActivatedThisGame() ActivationTable
        +getAbilityResolvedThisTurn() ActivationTable
        +getAbilityActivatedThisTurn(SpellAbility ability) int
        +getAbilityActivatedThisGame(SpellAbility ability) int
        +getAbilityResolvedThisTurn(SpellAbility ability) int
        +addAbilityResolved(SpellAbility ability) void
        +getAbilityResolvedThisTurnActivators(SpellAbility ability) List~Player~
        +resetAbilityResolvedThisTurn() void
        +getChosenModes(SpellAbility ability, String type) List~String~
        +addChosenModes(SpellAbility ability, String mode, boolean yourCombat) void
        +resetChosenModeTurn() void
        +getPlaneswalkerAbilityActivated() int
        +addPlaneswalkerAbilityActivated() void
        +planeswalkerActivationLimitUsed() boolean
        +resetActivationsPerTurn() void
        +addCanBlockAdditional(int n, long timestamp) void
        +removeCanBlockAdditional(long timestamp) boolean
        +canBlockAdditional() int
        +addCanBlockAny(long timestamp) void
        +removeCanBlockAny(long timestamp) boolean
        +canBlockAny() boolean
        +removeChangedState() boolean
        +getCombatLKI() CombatLki
        +setCombatLKI(CombatLki combatLKI) void
        +isAttacking() boolean
        +ignoreLegendRule() boolean
        +attackVigilance() boolean
        +isAbilitySick() boolean
        +isWitherDamage() boolean
        +isInfectDamage(Player target) boolean
        +getUnlockedRooms() Set~CardStateName~
        +setUnlockedRooms(Set~CardStateName~ set) void
        +getUnlockedRoomNames() List~String~
        +getLockedRooms() Set~CardStateName~
        +getLockedRoomNames() List~String~
        +unlockRoom(Player p, CardStateName stateName) boolean
        +lockRoom(Player p, CardStateName stateName) boolean
        +updateRooms() void
        +getEmptyRoomState() CardState
        +getUnlockAbility(CardStateName state) SpellAbility
        +copyFrom(Card in) void
        +Card(int id0, Game game0)
        +Card(int id0, IPaperCard paperCard0, Game game0)
        +Card(int id0, IPaperCard paperCard0, Game game0, Tracker tracker0)
    }
    Card --|> GameEntity : extends
    Card ..|> Comparable : implements
    Card ..|> IHasSVars : implements
    Card ..|> ITranslatable : implements
    Card ..> AbilityKey : uses
    Card ..> ActivationTable : uses
    Card ..> BorderColor : uses
    Card ..> CardArtPreference : uses
    Card ..> CardChangedName : uses
    Card ..> CardChangedType : uses
    Card ..> CardChangedWords : uses
    Card ..> CardCloneStates : uses
    Card ..> CardCollection : uses
    Card ..> CardCollectionView : uses
    Card ..> CardColor : uses
    Card ..> CardDamageHistory : uses
    Card ..> CardDb : uses
    Card ..> CardEdition : uses
    Card ..> CardManaCost : uses
    Card ..> CardPlayOption : uses
    Card ..> CardRarity : uses
    Card ..> CardRules : uses
    Card ..> CardState : uses
    Card ..> CardStateName : uses
    Card ..> CardTraitBase : uses
    Card ..> CardTraitChanges : uses
    Card ..> CardType : uses
    Card ..> CardTypeView : uses
    Card ..> CardView : uses
    Card ..> ColorSet : uses
    Card ..> Combat : uses
    Card ..> CombatLki : uses
    Card ..> Companion : uses
    Card ..> Cost : uses
    Card ..> CountKeywordVisitor : uses
    Card ..> CounterType : uses
    Card ..> DamageType : uses
    Card ..> Direction : uses
    Card ..> Equip : uses
    Card ..> EvenOdd : uses
    Card ..> FCollection : uses
    Card ..> FCollectionView : uses
    Card ..> Game : uses
    Card ..> GameCommand : uses
    Card ..> GameEntityCounterTable : uses
    Card ..> GameEventCardAttachment : uses
    Card ..> GameEventCardCounters : uses
    Card ..> GameEventCardDamaged : uses
    Card ..> GameEventCardPhased : uses
    Card ..> GameEventCardStatsChanged : uses
    Card ..> GameEventCardTapped : uses
    Card ..> GameEventDoorChanged : uses
    Card ..> GameEventSprocketUpdate : uses
    Card ..> GamePieceType : uses
    Card ..> HasKeywordVisitor : uses
    Card ..> ICardChangedType : uses
    Card ..> ICardFace : uses
    Card ..> ICardTraitChanges : uses
    Card ..> IKeywordsChange : uses
    Card ..> IPaperCard : uses
    Card ..> Keyword : uses
    Card ..> KeywordCollection : uses
    Card ..> KeywordInterface : uses
    Card ..> KeywordWithType : uses
    Card ..> KeywordsChange : uses
    Card ..> ListKeywordVisitor : uses
    Card ..> ManaCost : uses
    Card ..> ManaCostBeingPaid : uses
    Card ..> OptionalCost : uses
    Card ..> PaperCard : uses
    Card ..> PerpetualInterface : uses
    Card ..> Player : uses
    Card ..> PlayerCollection : uses
    Card ..> RemoveType : uses
    Card ..> ReplaceMoved : uses
    Card ..> ReplacementEffect : uses
    Card ..> SpellAbility : uses
    Card ..> SpellPermanent : uses
    Card ..> SplitCMCMode : uses
    Card ..> StatBreakdown : uses
    Card ..> StateChangedType : uses
    Card ..> StaticAbility : uses
    Card ..> Supertype : uses
    Card ..> Tracker : uses
    Card ..> Trigger : uses
    Card ..> TriggerHandler : uses
    Card ..> Visitor : uses
    Card ..> WordChangedType : uses
    Card ..> Zone : uses
    Card ..> ZoneType : uses
```
...
- [[forge.card.CardChangedType|CardChangedType]]
...
- [[forge.card.StateChangedType|StateChangedType]]
- [[forge.card.WordChangedType|WordChangedType]]
...
- [[forge.game.card.ActivationTable|ActivationTable]]
- [[forge.game.card.Card.CardChangedName|CardChangedName]]
- [[forge.game.card.Card.CardColor|CardColor]]
- [[forge.game.card.Card.CardManaCost|CardManaCost]]
- [[forge.game.card.Card.CountKeywordVisitor|CountKeywordVisitor]]
- [[forge.game.card.Card.HasKeywordVisitor|HasKeywordVisitor]]
- [[forge.game.card.Card.ListKeywordVisitor|ListKeywordVisitor]]
- [[forge.game.card.Card.SplitCMCMode|SplitCMCMode]]
- [[forge.game.card.Card.StatBreakdown|StatBreakdown]]
- [[forge.game.card.CardChangedWords|CardChangedWords]]
...
- [[forge.game.keyword.Equip|Equip]]
