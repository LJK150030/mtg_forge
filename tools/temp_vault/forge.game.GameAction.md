...
classDiagram
    class GameAction {
        -Game game
        -boolean holdCheckingStaticAbilities
        -Comparator~StaticAbility~ effectOrder
        +changeZone(Zone zoneFrom, Zone zoneTo, Card c, Integer position, SpellAbility cause) Card
        -changeZone(Zone zoneFrom, Zone zoneTo, Card c, Integer position, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        -setupStaticEffect(Card copied, SpellAbility cause) Card
        -cleanStaticEffect(Card eff, Card copied) void
        -storeChangesZoneAll(Card c, Zone zoneFrom, Zone zoneTo, Map~AbilityKey,Object~ params) void
        -unattachCardLeavingBattlefield(Card copied, Card old) void
        +moveTo(Zone zoneTo, Card c, SpellAbility cause) Card
        +moveTo(Zone zoneTo, Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveTo(ZoneType name, Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveTo(ZoneType name, Card c, int libPosition, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        -moveTo(Zone zoneTo, Card c, Integer position, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToStack(Card c, SpellAbility cause) Card
        +moveToStack(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToGraveyard(Card c, SpellAbility cause) Card
        +moveToGraveyard(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToHand(Card c, SpellAbility cause) Card
        +moveToHand(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToPlay(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToPlay(Card c, Player p, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToBottomOfLibrary(Card c, SpellAbility cause) Card
        +moveToBottomOfLibrary(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToLibrary(Card c, SpellAbility cause) Card
        +moveToLibrary(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToLibrary(Card c, int libPosition, SpellAbility cause) Card
        +moveToLibrary(Card c, int libPosition, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToVariantDeck(Card c, ZoneType zone, int deckPosition, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +moveToJunkyard(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +exile(CardCollection cards, SpellAbility cause, Map~AbilityKey,Object~ params) CardCollection
        +exile(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +exileEffect(Card effect) Card
        +moveToCommand(Card effect, SpellAbility sa) void
        +ceaseToExist(Card c, boolean skipTrig) void
        +controllerChangeZoneCorrection(Card c) void
        -setHoldCheckingStaticAbilities(boolean mode) void
        -isCheckingStaticAbilitiesOnHold() boolean
        +hasStaticAbilityAffectingZone(ZoneType zone, StaticAbilityLayer layer) boolean
        +checkStaticAbilities() void
        +checkStaticAbilities(boolean runEvents) void
        +checkStaticAbilities(boolean runEvents, Set~Card~ affectedCards, CardCollectionView preList) void
        -findStaticAbilityToApply(StaticAbilityLayer layer, List~StaticAbility~ staticsForLayer, CardCollectionView preList, Map~StaticAbility,CardCollectionView~ affectedPerAbility, Table~StaticAbility,StaticAbility,Set~ dependencies) StaticAbility
        -generateContinuousEffectChanges(StaticAbilityLayer layer, StaticAbility stAb) Iterable~Object~
        +checkStateEffects(boolean runEvents) boolean
        +checkStateEffects(boolean runEvents, Set~Card~ affectedCards) boolean
        -stateBasedAction_Saga(Card c, CardCollection sacrificeList) boolean
        -stateBasedAction_Battle(Card c, CardCollection removeList) boolean
        -stateBasedAction_Role(Card c, CardCollection removeList) boolean
        -stateBasedAction_Dungeon(Card c) void
        -stateBasedAction_Scheme(Card c) void
        -stateBasedAction704_attach(Card c, CardCollection unAttachList) boolean
        -stateBasedAction_Contraption(Card c, CardCollection removeList) boolean
        -stateBasedAction704_5u(Player p) boolean
        -stateBasedAction_Commander(Card c, Map~AbilityKey,Object~ mapParams) boolean
        -stateBasedAction704_5q(Card c) boolean
        -stateBasedAction704_5r(Card c) boolean
        -stateBasedAction704_5d(Card c) boolean
        +checkGameOverCondition() void
        -handlePlaneswalkerRule(Player p, CardCollection noRegCreats) boolean
        -handleLegendRule(Player p, CardCollection noRegCreats) boolean
        -handleWorldRule(CardCollection noRegCreats) boolean
        +sacrifice(Iterable~Card~ list, SpellAbility source, boolean effect, Map~AbilityKey,Object~ params) CardCollection
        +destroy(Card c, SpellAbility sa, boolean regenerate, Map~AbilityKey,Object~ params) boolean
        #sacrificeDestroy(Card c, SpellAbility cause, Map~AbilityKey,Object~ params) Card
        +revealTo(Card card, Player to) void
        +revealTo(CardCollectionView cards, Player to) void
        +revealTo(CardCollectionView cards, Player to, String messagePrefix) void
        +revealTo(Card card, Iterable~Player~ to) void
        +revealTo(CardCollectionView cards, Iterable~Player~ to) void
        +revealTo(CardCollectionView cards, Iterable~Player~ to, String messagePrefix, boolean addSuffix) void
        +reveal(CardCollectionView cards, Player cardOwner) void
        +reveal(CardCollectionView cards, Player cardOwner, boolean dontRevealToOwner) void
        +reveal(CardCollectionView cards, Player cardOwner, boolean dontRevealToOwner, String messagePrefix) void
        +reveal(CardCollectionView cards, Player cardOwner, boolean dontRevealToOwner, String messagePrefix, boolean msgAddSuffix) void
        +reveal(CardCollectionView cards, ZoneType zt, Player cardOwner, boolean dontRevealToOwner, String messagePrefix) void
        +reveal(CardCollectionView cards, ZoneType zt, Player cardOwner, boolean dontRevealToOwner, String messagePrefix, boolean msgAddSuffix) void
        +revealUnplayableByAI(String title, Map~Player,Map~ unplayableCards) void
        +revealAnte(String title, Multimap~Player,PaperCard~ removedAnteCards) void
        +revealUnsupported(Map~Player,List~ unsupported) void
        +notifyOfValue(SpellAbility saSource, GameObject relatedTarget, String value, Player playerExcept) void
        -drawStartingHand(Player p1) void
        -getLandRatio(List~Card~ deck) float
        -getHandScore(List~Card~ hand, float landRatio) float
        +startGame(GameOutcome lastGameOutcome) void
        +startGame(GameOutcome lastGameOutcome, Runnable startGameHook) void
        -determineFirstTurnPlayer(GameOutcome lastGameOutcome) Player
        -runPreOpeningHandActions(Player first) void
        -runOpeningHandActions(Player first) Player
        +invoke(Runnable proc) void
        +becomeMonarch(Player p, String set) void
        +takeInitiative(Player p, String set) void
        +scry(List~Player~ players, int numScry, SpellAbility cause) void
        +mill(PlayerCollection millers, int numCards, ZoneType destination, SpellAbility sa, Map~AbilityKey,Object~ moveParams) CardCollection
        +dealDamage(boolean isCombat, CardDamageMap damageMap, CardDamageMap preventMap, GameEntityCounterTable counterTable, SpellAbility cause) void
        +completeDungeon(Player player, Card dungeon) void
        -attachAuraOnIndirectETB(Card source, Map~AbilityKey,Object~ params) boolean
        +getLastState(AbilityKey key, SpellAbility cause, Map~AbilityKey,Object~ params, boolean refreshIfEmpty) CardCollectionView
        +GameAction(Game game0)
    }
    GameAction ..> AbilityKey : uses
    GameAction ..> BackupPlanService : uses
    GameAction ..> Card : uses
    GameAction ..> CardCollection : uses
    GameAction ..> CardCollectionView : uses
    GameAction ..> CardCopyService : uses
    GameAction ..> CardDamageMap : uses
    GameAction ..> CardZoneTable : uses
    GameAction ..> CounterType : uses
    GameAction ..> DeckSection : uses
    GameAction ..> EmptySa : uses
    GameAction ..> FCollection : uses
    GameAction ..> FCollectionView : uses
    GameAction ..> Game : uses
    GameAction ..> GameCommand : uses
    GameAction ..> GameEndReason : uses
    GameAction ..> GameEntity : uses
    GameAction ..> GameEntityCounterTable : uses
    GameAction ..> GameEventAddLog : uses
    GameAction ..> GameEventCardChangeZone : uses
    GameAction ..> GameEventCardDestroyed : uses
    GameAction ..> GameEventCardStatsChanged : uses
    GameAction ..> GameEventCardTapped : uses
    GameAction ..> GameEventFlipCoin : uses
    GameAction ..> GameEventGameStarted : uses
    GameAction ..> GameEventScry : uses
    GameAction ..> GameObject : uses
    GameAction ..> GameOutcome : uses
    GameAction ..> GameType : uses
    GameAction ..> KeywordInterface : uses
    GameAction ..> MulliganService : uses
    GameAction ..> PaperCard : uses
    GameAction ..> Player : uses
    GameAction ..> PlayerCollection : uses
    GameAction ..> PlayerZone : uses
    GameAction ..> PlayerZoneBattlefield : uses
    GameAction ..> ReplacementEffect : uses
    GameAction ..> ReplacementResult : uses
    GameAction ..> SpellAbility : uses
    GameAction ..> SpellPermanent : uses
    GameAction ..> StaticAbility : uses
    GameAction ..> StaticAbilityLayer : uses
    GameAction ..> Visitor : uses
    GameAction ..> Zone : uses
    GameAction ..> ZoneType : uses
```
...
- [[forge.game.extrahands.BackupPlanService|BackupPlanService]]
- [[forge.game.keyword.KeywordInterface|KeywordInterface]]
- [[forge.game.mulligan.MulliganService|MulliganService]]
