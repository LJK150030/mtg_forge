...
## Source
`forge-ai/src/main/java/forge/ai/AiProfileUtil.java` Ã¢â‚¬â€ declaration excerpt
...
## Python
`forge/ai/AiProfileUtil/AISideboardingMode.py`
...
class AISideboardingMode(Enum):
    ...
    @staticmethod
    def normalizedValueOf(value: str) -> "AISideboardingMode":
        return AISideboardingMode[value.replace(" ", "")]
```
