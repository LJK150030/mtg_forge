...
tags:
  ...
  - module/forge-game
  - pkg/forge/game/cost
fqn: forge.game.cost.CostReveal
...
classDiagram
    class CostReveal {
        ...
        #List~ZoneType~ revealFrom
        +isReusable() boolean
        +isRenewable() boolean
        +getRevealFrom() List~ZoneType~
        ...
        +paymentOrder() int
        +CostReveal(String amount, String type, String description)
        +CostReveal(String amount, String type, String description, String zoneType)
    }
    CostReveal --|> CostPartWithList : extends
    CostReveal ..> Card : uses
    CostReveal ..> CardCollection : uses
    CostReveal ..> CardCollectionView : uses
    CostReveal ..> GameEventAddLog : uses
    CostReveal ..> ICostVisitor : uses
    CostReveal ..> Player : uses
    CostReveal ..> SpellAbility : uses
    CostReveal ..> ZoneType : uses
```
