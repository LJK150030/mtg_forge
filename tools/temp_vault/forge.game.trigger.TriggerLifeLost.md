...
fqn: forge.game.trigger.TriggerLifeLost
...
```mermaid
classDiagram
    class TriggerLifeLost {
        +performTest(Map~AbilityKey,Object~ runParams) boolean
        +setTriggeringObjects(SpellAbility sa, Map~AbilityKey,Object~ runParams) void
        +getImportantStackObjects(SpellAbility sa) String
        +TriggerLifeLost(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerLifeLost --|> Trigger : extends
    TriggerLifeLost ..> AbilityKey : uses
    TriggerLifeLost ..> Card : uses
    TriggerLifeLost ..> SpellAbility : uses
```
