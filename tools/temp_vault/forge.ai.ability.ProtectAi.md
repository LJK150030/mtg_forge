...
fqn: forge.ai.ability.ProtectAi
...
classDiagram
    class ProtectAi {
        -hasProtectionFrom(Card card, String color) boolean
        -hasProtectionFromAny(Card card, Iterable~String~ colors) boolean
        -hasProtectionFromAll(Card card, Iterable~String~ colors) boolean
        +toProtectFrom(Card threat, SpellAbility sa) String
        +getProtectCreatures(Player ai, SpellAbility sa) CardCollection
        #checkPhaseRestrictions(Player ai, SpellAbility sa, PhaseHandler ph) boolean
        #checkApiLogic(Player ai, SpellAbility sa) AiAbilityDecision
        -protectTgtAI(Player ai, SpellAbility sa, boolean mandatory) AiAbilityDecision
        -protectMandatoryTarget(Player ai, SpellAbility sa) boolean
        #doTriggerNoCost(Player ai, SpellAbility sa, boolean mandatory) AiAbilityDecision
        +chkDrawback(Player ai, SpellAbility sa) AiAbilityDecision
    }
    ProtectAi --|> SpellAbilityAi : extends
    ProtectAi ..> AiAbilityDecision : uses
    ProtectAi ..> AiAttackController : uses
    ProtectAi ..> Card : uses
    ProtectAi ..> CardCollection : uses
    ProtectAi ..> Combat : uses
    ProtectAi ..> Game : uses
    ProtectAi ..> GameObject : uses
    ProtectAi ..> PhaseHandler : uses
    ProtectAi ..> Player : uses
    ProtectAi ..> SpellAbility : uses
    ProtectAi ..> TargetRestrictions : uses
```
