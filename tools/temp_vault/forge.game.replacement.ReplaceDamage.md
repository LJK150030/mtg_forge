...
fqn: forge.game.replacement.ReplaceDamage
...
classDiagram
    class ReplaceDamage {
        ...
        +ReplaceDamage(Map~String,String~ map, Card host, boolean intrinsic)
    }
    ReplaceDamage --|> ReplacementEffect : extends
    ReplaceDamage ..> AbilityKey : uses
    ReplaceDamage ..> Card : uses
    ReplaceDamage ..> Game : uses
    ReplaceDamage ..> GameEntity : uses
    ReplaceDamage ..> Player : uses
    ReplaceDamage ..> SpellAbility : uses
```
