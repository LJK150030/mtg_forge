...
fqn: forge.game.trigger.TriggerCounterRemoved
...
classDiagram
    class TriggerCounterRemoved {
        ...
        +TriggerCounterRemoved(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerCounterRemoved --|> Trigger : extends
    TriggerCounterRemoved ..> AbilityKey : uses
    TriggerCounterRemoved ..> Card : uses
    TriggerCounterRemoved ..> CounterType : uses
    TriggerCounterRemoved ..> SpellAbility : uses
```
