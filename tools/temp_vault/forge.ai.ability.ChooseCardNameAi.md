...
fqn: forge.ai.ability.ChooseCardNameAi
...
classDiagram
    ...
    ChooseCardNameAi --|> SpellAbilityAi : extends
    ChooseCardNameAi ..> AiAbilityDecision : uses
    ChooseCardNameAi ..> Card : uses
    ChooseCardNameAi ..> CardCollection : uses
    ChooseCardNameAi ..> CardDb : uses
    ChooseCardNameAi ..> CardRules : uses
    ChooseCardNameAi ..> ICardFace : uses
    ChooseCardNameAi ..> PaperCard : uses
    ChooseCardNameAi ..> Player : uses
    ChooseCardNameAi ..> SpellAbility : uses
    ChooseCardNameAi ..> TargetRestrictions : uses
```
