...
fqn: forge.game.trigger.TriggerLifeLostAll
...
```mermaid
classDiagram
    class TriggerLifeLostAll {
        +performTest(Map~AbilityKey,Object~ runParams) boolean
        +setTriggeringObjects(SpellAbility sa, Map~AbilityKey,Object~ runParams) void
        +getImportantStackObjects(SpellAbility sa) String
        -filteredMap(Map~Player,Integer~ map) Map~Player,Integer~
        +TriggerLifeLostAll(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerLifeLostAll --|> Trigger : extends
    TriggerLifeLostAll ..> AbilityKey : uses
    TriggerLifeLostAll ..> Card : uses
    TriggerLifeLostAll ..> Player : uses
    TriggerLifeLostAll ..> SpellAbility : uses
```
