...
## Python
`forge/card/CardEdition/FoilType.py`
...
class FoilType(Enum):
    NOT_SUPPORTED = auto()  # sets before Urza's Legacy
    OLD_STYLE = auto()  # sets between Urza's Legacy and 8th Edition
    MODERN = auto()  # 8th Edition and newer
```
