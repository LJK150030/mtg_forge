...
fqn: forge.game.trigger.TriggerForetell
...
```mermaid
classDiagram
    class TriggerForetell {
        +getImportantStackObjects(SpellAbility sa) String
        +setTriggeringObjects(SpellAbility sa, Map~AbilityKey,Object~ runParams) void
        +performTest(Map~AbilityKey,Object~ runParams) boolean
        +TriggerForetell(Map~String,String~ params, Card host, boolean intrinsic)
    }
    TriggerForetell --|> Trigger : extends
    TriggerForetell ..> AbilityKey : uses
    TriggerForetell ..> Card : uses
    TriggerForetell ..> SpellAbility : uses
```
