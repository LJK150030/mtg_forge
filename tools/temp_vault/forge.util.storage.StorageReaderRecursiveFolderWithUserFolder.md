---
aliases:
  - StorageReaderRecursiveFolderWithUserFolder
tags:
  - java/class
  - module/forge-core
  - pkg/forge/util/storage
fqn: forge.util.storage.StorageReaderRecursiveFolderWithUserFolder
...
```mermaid
classDiagram
    class StorageReaderRecursiveFolderWithUserFolder {
        #File directory
        #File userDirectory
        ...
        -listFileTree(File dir) Collection~File~
        #read(File file) T
        #getFileFilter() FilenameFilter
        +getItemKey(T item) String
        +getSubFolders() Iterable~File~
        +StorageReaderRecursiveFolderWithUserFolder(File itemDir0, File userItemDir0, Function~T,String~ keySelector0)
    }
    StorageReaderRecursiveFolderWithUserFolder --|> StorageReaderBase : extends
```
