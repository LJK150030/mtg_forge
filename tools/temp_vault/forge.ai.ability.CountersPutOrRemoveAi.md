---
aliases:
  - CountersPutOrRemoveAi
tags:
  - java/class
  - module/forge-ai
  - pkg/forge/ai/ability
fqn: forge.ai.ability.CountersPutOrRemoveAi
...
classDiagram
    ...
    CountersPutOrRemoveAi --|> SpellAbilityAi : extends
    CountersPutOrRemoveAi ..> AiAbilityDecision : uses
    CountersPutOrRemoveAi ..> BinaryChoiceType : uses
    CountersPutOrRemoveAi ..> Card : uses
    CountersPutOrRemoveAi ..> CardCollection : uses
    CountersPutOrRemoveAi ..> CardCollectionView : uses
    CountersPutOrRemoveAi ..> CounterType : uses
    CountersPutOrRemoveAi ..> Game : uses
    CountersPutOrRemoveAi ..> Player : uses
    CountersPutOrRemoveAi ..> SpellAbility : uses
    CountersPutOrRemoveAi ..> TargetRestrictions : uses
```
