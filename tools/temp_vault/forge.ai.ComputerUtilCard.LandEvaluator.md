...
## Python
`forge/ai/ComputerUtilCard/LandEvaluator.py`

```python
from forge.game.card.Card import Card


class LandEvaluator(Function):
    def apply(self, card: Card) -> int:
        return GameStateEvaluator.evaluateLand(card)
```
