...
fqn: forge.game.ability.effects.TokenEffect
...
classDiagram
    ...
    TokenEffect --|> TokenEffectBase : extends
    TokenEffect ..> Card : uses
    TokenEffect ..> CardZoneTable : uses
    TokenEffect ..> Game : uses
    TokenEffect ..> GameEventCombatChanged : uses
    TokenEffect ..> GameEventTokenCreated : uses
    TokenEffect ..> Player : uses
    TokenEffect ..> SpellAbility : uses
```
...
## Source
`forge-game/src/main/java/forge/game/ability/effects/TokenEffect.java`
