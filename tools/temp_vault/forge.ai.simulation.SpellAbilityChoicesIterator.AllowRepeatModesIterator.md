...
## Python
`forge/ai/simulation/SpellAbilityChoicesIterator/AllowRepeatModesIterator.py`
...
class AllowRepeatModesIterator:
    def __init__(self, numChoices: int, min: int, max: int):
