...
## Python
`forge/game/event/EventValueChangeType.py`
...
class EventValueChangeType(Enum):
    Added = auto()
    Removed = auto()
    Cleared = auto()
    ComplexUpdate = auto()
